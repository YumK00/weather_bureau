...
void _help()
{
    ...
    printf("Sample:/A/tools/bin/procctl 3600 /A/tools/bin/dminingoracle /A/log/idc/dminingoracle_ZHOBTCODE.log "
              "\"<connstr>idc/idcpwd@snorcl11g_5</connstr><charset>Simplified Chinese_China.AL32UTF8</charset>"\
              ...
              "<bfilename>T_ZHOBTCODE</bfilename><efilename>togxpt</efilename><outpath>/A/idcdata/dmindata</outpath>"\
              "<timeout>30</timeout><pname>dminingoracle_ZHOBTCODE</pname>\"\n\n");
    printf("       /A/tools/bin/procctl   30 /A/tools/bin/dminingoracle /A/log/idc/dminingoracle_ZHOBTMIND.log "\
              "\"<connstr>idc/idcpwd@snorcl11g_5</connstr><charset>Simplified Chinese_China.AL32UTF8</charset>"\
              "<selectsql>select obtid,to_char(datetime,'yyyymmddhh24miss'),t,p,u,wd,wf,r,vis,keyid from T_ZHOBTMIND where keyid>:1 and obtid like '5%%%%'</selectsql>"\
              "<fieldstr>obtid,datetime,t,p,u,wd,wf,r,vis,keyid</fieldstr><fieldlen>5,19,8,8,8,8,8,8,8,15</fieldlen>"\
              "<bfilename>T_ZHOBTMIND</bfilename><efilename>togxpt</efilename><outpath>/A/idcdata/dmindata</outpath>"\
              "<starttime></starttime><incfield>keyid</incfield>"\
              "<incfilename>/A/idcdata/dmining/dminingoracle_ZHOBTMIND_togxpt.keyid</incfilename>"\
              "<timeout>30</timeout><pname>dminingoracle_ZHOBTMIND_togxpt</pname>"\
              "<maxcount>1000</maxcount><connstr1>scott/111111@snorcl11g_5</connstr1>\"\n\n");
...
bool readincfield()
{
    ...
    if (strlen(starg.connstr1)!=0)
    {
        ...
        logfile.write("connect db(%s) success.\n",starg.connstr1);
