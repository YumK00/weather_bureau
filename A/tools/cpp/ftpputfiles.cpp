...
void _help()
{
    ...
    printf("Sample:/A/tools/bin/procctl 30 /A/tools/bin/ftpputfiles /A/log/idc/ftpputfiles_surfdata.log "\
              "\"<host>192.168.5.5:21</host><mode>1</mode><username>dba</username><password>222222</password>"\
              "<localpath>/home/dba/tmp</localpath><remotepath>/A/surfdata</remotepath>"\
              "<matchname>*.csv</matchname>"\
              "<ptype>1</ptype><localpathbak>/A/tmp/ftptmpfile</localpathbak>"\
              "<okfilename>/A/tmp/ftplist/ftpputfiles_surfdata.xml</okfilename>"\
